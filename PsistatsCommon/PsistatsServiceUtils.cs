...
namespace Psistats.ServiceUtils
{
    ...
    {
        public static string SERVICE_NAME = "PsistatsService";
        ...
        {
            return ServiceUtils.ServiceIsInstalled(Utils.SERVICE_NAME);
        }

        public static bool IsRunning()
        {
            ServiceState state = ServiceUtils.GetServiceStatus(Utils.SERVICE_NAME);
